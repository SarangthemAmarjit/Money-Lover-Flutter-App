...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  int thismonthExpenditure = 0;
  int lastmonthExpenditure = 0;
  int thisweekExpenditure = 0;
  int lastweekExpenditure = 0;
  alldata() {
    ...
    cateogoryname = recent.categoyname;
    cateogoryname2 = recent.categoyname2;
    transaction = recent.transaction;
    transaction2 = recent.transaction2;
    transactionidlist = recent.transactionidlist;

    cateogorynameEx = s.top3categoryname;
    transactionEx = s.top3transaction;
    expensetotalamount = s.expensetotalamount;
    thismonthExpenditure = thismonth.expensetotalamountthismonth;
    lastmonthExpenditure = lastmonth.expensetotalamountlastmonth;
    thisweekExpenditure = thisweek.expensetotalamountthisweek;
    lastweekExpenditure = lastweek.expensetotalamountlastweek;
  }

  Future refreshdata() async {
    BlocProvider.of<FetchdataCubit>(context, listen: false).getdatalist();

    BlocProvider.of<QuerydatathismonthCubit>(context, listen: false)
        .getthismonthquery();
    BlocProvider.of<QuerydatalastmonthCubit>(context, listen: false)
        .getlastmonthquery();
    BlocProvider.of<QuerydatathisweekCubit>(context, listen: false)
        .getthisweekquery();
    BlocProvider.of<QuerydatalastweekCubit>(context, listen: false)
        .getlastweekquery();
